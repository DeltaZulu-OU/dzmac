...
namespace DZMACLib
{
    ...
    public class VendorList : IDisposable, IReadOnlyList<Vendor>
    {
        ...
        private static string ResolveDatabasePath()
        {
            ...
            {
                var basePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "DZMACLib");
            ...
            {
                throw new DZMACLibException("Resolved OUI cache path has no parent directory.");
            }
            ...
            {
                throw new DZMACLibException($"Failed to prepare OUI cache directory: {directory}", ex);
            }
